...
export function useGetArticles() {
  ...
  const { loading, error } = useAppSelector((state) => state.articles.getMany)
...
export function useGetArticle() {
  const dispatch = useAppDispatch()
  const { loading, error } = useAppSelector((state) => state.articles.getOne)
...
export function useCreateArticle() {
  const dispatch = useAppDispatch()
  const { loading, error } = useAppSelector((state) => state.articles.createOne)
  return {
...
export function useUpdateArticle() {
  const dispatch = useAppDispatch()
  const { loading, error } = useAppSelector((state) => state.articles.updateOne)
  return {
...
export function useDeleteArticle() {
  const dispatch = useAppDispatch()
  const { loading, error } = useAppSelector((state) => state.articles.deleteOne)
  return {
...
export function useGetFeeds() {
  const dispatch = useAppDispatch()
  const { loading, error } = useAppSelector((state) => state.articles.getFeeds)
